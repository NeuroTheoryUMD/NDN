...
class Network(object):
    ...
    def train(
        ...
        Args:
            ...
            partial_fit (dictionary, optional): partial training of separable layers
                example: {'net0L1': 1, 'net0L3': 0} means train only spatial part of
                layer_1 in net_0 and temporal part of layer_3 in net_0...
